...
| **Interactive Origin Selection** | ✅ COMPLETED | "SET ORIGIN" control in Disaster Properties panel allows commanders to click anywhere on the map to set disaster epicenter/source, rendered with a pulsing target marker and synchronized to the backend. |
